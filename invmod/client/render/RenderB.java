...
import invmod.client.render.ModelBird;
...
extends RenderLiving {
    ...
    public RenderB() {
        super((ModelBase)new ModelBird(), 0.4f);
        this.modelBird = (ModelBird)this.field_77045_g;
    }
    ...
    public void renderBz(EntityIMBird entityBird, double renderX, double renderY, double renderZ, float interpYaw, float partialTick) {
        ...
        super.func_76986_a((EntityLiving)entityBird, renderX, renderY, renderZ, interpYaw, partialTick);
    }

    public void func_76986_a(Entity entity, double d, double d1, double d2, float f, float f1) {
        this.renderBz((EntityIMBird)entity, d, d1, d2, f, f1);
    }
