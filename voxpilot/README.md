...
## Play-faithful scenarios (convention)

Prefer scenarios that mirror real play over pure `give` smoke tests:

1. Place / open blocks the player would use (Nexus, crafting table).
