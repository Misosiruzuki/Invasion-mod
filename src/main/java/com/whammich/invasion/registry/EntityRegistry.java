...
public final class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<EntityIMCreeper>> CREEPER = ENTITIES.register(
            "im_creeper",
            () -> EntityType.Builder.<EntityIMCreeper>of(EntityIMCreeper::new, MobCategory.MONSTER)
    ...
    public static final RegistryObject<EntityType<EntityIMPigEngy>> PIG_ENGINEER = ENTITIES.register(
            "im_pig_engineer",
            () -> EntityType.Builder.<EntityIMPigEngy>of(EntityIMPigEngy::new, MobCategory.MONSTER)
    ...
    public static final RegistryObject<EntityType<EntityIMBird>> BIRD = ENTITIES.register(
            "im_bird",
            () -> EntityType.Builder.<EntityIMBird>of((type, level) -> new EntityIMBird(type, level), MobCategory.MONSTER)
    ...
    public static final RegistryObject<EntityType<EntityIMGiantBird>> GIANT_BIRD = ENTITIES.register(
            "im_giant_bird",
            () -> EntityType.Builder.<EntityIMGiantBird>of((type, level) -> new EntityIMGiantBird(type, level), MobCategory.MONSTER)
