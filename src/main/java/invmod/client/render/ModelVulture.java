...
extends ModelBase {
    ...
    public ModelVulture(float par1) {
        ...
        this.upperBeak.func_78789_a(-2.5f, -1.0f, -5.0f, 5, 2, 8);
        this.upperBeak.func_78793_a(0.0f, -0.8f, -10.0f);
        this.upperBeakTip = new ModelRenderer((ModelBase)this, 72, 118);
        this.upperBeakTip.func_78787_b(128, 128);
        this.upperBeakTip.func_78789_a(-1.0f, -1.0f, -1.0f, 2, 2, 2);
        this.upperBeakTip.func_78793_a(0.0f, 0.0f, -6.0f);
        this.lowerBeak = new ModelRenderer((ModelBase)this, 80, 118);
        this.lowerBeak.func_78787_b(128, 128);
        this.lowerBeak.func_78789_a(-2.5f, -1.0f, -5.0f, 5, 2, 8);
        this.lowerBeak.func_78793_a(0.0f, 1.5f, -10.0f);
        this.lowerBeakTip = new ModelRenderer((ModelBase)this, 78, 121);
        this.lowerBeakTip.func_78787_b(128, 128);
        this.lowerBeakTip.func_78789_a(-1.0f, -0.5f, -1.0f, 2, 1, 2);
        this.lowerBeakTip.func_78793_a(0.0f, -0.5f, -6.0f);
        ...
        EnumMap<BonesMouth, ModelRenderer> beakMap = new EnumMap<BonesMouth, ModelRenderer>(BonesMouth.class);
        beakMap.put(BonesMouth.UPPER_MOUTH, this.upperBeak);
        beakMap.put(BonesMouth.LOWER_MOUTH, this.lowerBeak);
        this.animationBeak = new ModelAnimator<BonesMouth>(beakMap, AnimationRegistry.instance().getAnimation("bird_beak"));
    ...
    public void setFlyingAnimations(AnimationState wingState, AnimationState legState, AnimationState beakState, float roll, float headYaw, float headPitch, float parTick) {
        ...
        if (legAction == AnimationAction.RUN && legProgress >= 0.109195f && legProgress < 0.5373563f) {
            if ((legProgress += 0.03735632f) >= 0.5373563f) {
                legProgress -= 0.4281609f;
            }
            float t = (float)Math.PI * 8 * legProgress / 0.8908046f;
            this.body.field_78795_f += (float)(-Math.cos(t) * 0.04);
            this.neck1.field_78795_f += (float)(Math.cos(t) * 0.08);
            this.body.field_78797_d += -((float)(Math.cos(t) * 1.9));
        }
        if (wingAction == AnimationAction.WINGFLAP) {
            ...
            tmp244_241.field_78795_f = (float)((double)tmp244_241.field_78795_f + (double)MathHelper.func_76134_b((float)(flapCycle * 3.141593f * 2.0f)) * 0.08726646324990228);
            ModelRenderer tmp274_271 = this.leftThigh;
            tmp274_271.field_78795_f = (float)((double)tmp274_271.field_78795_f + (double)MathHelper.func_76134_b((float)(flapCycle * 3.141593f * 2.0f)) * 0.08726646324990228);
            ModelRenderer tmp304_301 = this.tail;
            tmp304_301.field_78795_f = (float)((double)tmp304_301.field_78795_f + (double)MathHelper.func_76134_b((float)(flapCycle * 3.141593f * 2.0f)) * 0.03490658588512815);
        }
